...
experience <- tribble(
    ...
    "Psychologist and Researcher", "Human Performance Optimisation Centre, Beacon Red", "06/2024", "Present", "Abu Dhabi, UAE", "Research and Development Lead for the Human Performance Optimisation Centre at Beacon Red",
    "Psychologist and Researcher", "Human Performance Optimisation Centre, Beacon Red", "06/2024", "Present", "Abu Dhabi, UAE", "Leading human performance research, data analysis and behavioural insight development",
    "Psychologist and Researcher", "Human Performance Optimisation Centre, Beacon Red", "06/2024", "Present", "Abu Dhabi, UAE", "Engaging with clients, vendors and research partners to market and develop new human performance capabilities",
...
education <- tribble(
    ...
    "Certificate in Management and Leadership", "Chartered Management Institute", "2025", "2026", "CMI, UK", "Level 5 certificate in managament and leadership, ongoing, expected award date January 2026",
...
projects <- tribble(
    ...
    "Improving Human Performance in X-ray Baggage Screening", "Visual Cognition Lab, Department of Psychology, University of Cambridge", "2018 --> 2021", NA, "Won funding from the Defence and Security Accelerator (worth £266,359), worked closely with government and industry stakeholders (e.g., Dstl, QinetiQ), outputs included three published papers and a library of three-dimensional computerised tomography images for training and security research, materials available for parts of this work on GitHub (https://github.com/alexmuhl-r/3D-CT-Image-Enhancement) and Gorilla Open Materials (https://app.gorilla.sc/openmaterials/867312)",
...
skills <- tribble(
    ~area, ~skills,
    "Behavioural Science", "Experimental design, data collection, report writing, behavioural insights",
    ...
    "Statistics and Data", "Significance testing, linear models, clustering, outlier detection, decision modelling, Bayesian inference",   
